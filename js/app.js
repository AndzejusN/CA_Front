...
var data = [];
var keysLocalStorage = ['fname', 'lname', 'tel', 'mail', 'age', 'experience', 'groupRadio', 'groupCheckbox', 'volume'];
...
var studentsListData = [{
  ...
  studentInformation: 'Some a lot of text',
  studentGroup: 'second',
  studentStack: ['HTML', 'C++', 'C#', 'JS', 'Java', 'Python', 'Ruby', 'PHP'],
  knowledgeRating: 10
}];
...
form.addEventListener('submit', /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
    var fname, lname, tel, mail, age, experience, text, groupRadio, groupCheckbox, volume, validation, response, groupCheckboxToData, dataToStorage, dataFromLocalStorage;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            groupRadio = document.querySelector('input[name=group]:checked').value;
            groupCheckbox = document.querySelectorAll('input[name=groupCheckbox]:checked');
          ...
          case 15:
            groupCheckboxToData = _toConsumableArray(groupCheckbox).map(function (element, index) {
              if (index !== 0) {
            ...
            dataFromLocalStorage = getStudentsDataFromLocalstorage();
...
var inputs = document.querySelectorAll('input:not([type=radio]):not([type=checkbox]), select');
...
function resetLocalStorage() {
  keysLocalStorage.forEach(function (value) {
    localStorage.removeItem("".concat(value));
  });
}
...
var isDataInLocalStorage = getStudentsDataFromLocalstorage();
...
var studentsList = getStudentsDataFromLocalstorage();
